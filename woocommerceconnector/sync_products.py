...
def get_item_code(woocommerce_item, woocommerce_settings):
    ...
    elif woocommerce_settings.item_code_based_on == "Stock Keeping Unit":
        # Adds SKU Item ID options.
        # If SKU is left empty in woocommerce, item_code set to woocommerce product name
        if woocommerce_item.get("sku") == NULL:
            item_code = str(woocommerce_item.get("name"))
        else:
